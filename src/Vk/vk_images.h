...
namespace Vk{
    class ImageHelper{
        ...
        public:
            ...
            VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags properties, VkImage& image, VmaAllocation& imageAllocation, VmaMemoryUsage memoryUsageFlag);
